...
let slicedFruits: string[] = fruits.slice(1, 4);
console.log('Sliced portion:', slicedFruits);

// 7. concat() - Merges arrays
let moreFruits: string[] = ['Peach', 'Plum'];
...
let foundFruit: string | undefined = fruits.find(fruit => fruit.startsWith('S'));
...
let reversedFruits: string[] = [...fruits].reverse();
...
let fruitStringArray: string = fruits.toString();
